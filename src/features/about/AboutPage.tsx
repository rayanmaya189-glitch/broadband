      ...
      <div className="relative max-w-[92%] 2xl:max-w-[90rem] mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {stats.map((stat, i) => (
            ...
            >
              <TiltCard tiltDegree={5} glareOpacity={0.1}>
                <div className="glass-card rounded-2xl p-6 text-center border border-white/[0.06] transition-shadow duration-300 hover:shadow-2xl hover:shadow-accent-500/5">
                  <div className="p-3 rounded-xl bg-accent-400/10 w-fit mx-auto mb-4 group-hover:bg-accent-400/20 transition-colors">
        ...
        <motion.div
          ...
          className="glass-card-strong rounded-2xl p-8 sm:p-12 border border-white/[0.08]"
        >
          ...
          <div className="mt-8 grid sm:grid-cols-3 gap-6">
            {['Mission', 'Vision', 'Values'].map((title, i) => (
              ...
              >
                <TiltCard tiltDegree={4} glareOpacity={0.08}>
                  <div className="p-6 rounded-xl bg-white/[0.04] border border-white/[0.06] h-full transition-shadow duration-300 hover:shadow-xl hover:shadow-accent-500/5">
