...
use crate::modules::document::repository::document_repository_seaorm::DocumentRepositorySeaorm;
use crate::modules::document::request::document_request::*;
use crate::modules::document::response::document_response::*;

pub struct DocumentServiceSeaorm<'a> {
    repo: DocumentRepositorySeaorm<'a>,
}

impl<'a> DocumentServiceSeaorm<'a> {
    pub fn new(db: &'a DatabaseConnection) -> Self {
        Self { repo: DocumentRepositorySeaorm::new(db) }
    }
