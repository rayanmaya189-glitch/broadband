...
use crate::modules::accounting::repository::accounting_repository_seaorm::AccountingRepositorySeaorm;
use crate::modules::accounting::request::accounting_request::*;
use crate::modules::accounting::response::accounting_response::*;

pub struct AccountingServiceSeaorm<'a> {
    repo: AccountingRepositorySeaorm<'a>,
}

impl<'a> AccountingServiceSeaorm<'a> {
    pub fn new(db: &'a DatabaseConnection) -> Self {
        Self { repo: AccountingRepositorySeaorm::new(db) }
    }
