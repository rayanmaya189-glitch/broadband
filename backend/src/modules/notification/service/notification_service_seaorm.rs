...
use crate::modules::notification::repository::notification_repository_seaorm::NotificationRepositorySeaorm;
use crate::modules::notification::request::notification_request::*;
use crate::modules::notification::response::notification_response::*;

pub struct NotificationServiceSeaorm<'a> {
    repo: NotificationRepositorySeaorm<'a>,
}

impl<'a> NotificationServiceSeaorm<'a> {
    pub fn new(db: &'a DatabaseConnection) -> Self {
        Self { repo: NotificationRepositorySeaorm::new(db) }
    }
