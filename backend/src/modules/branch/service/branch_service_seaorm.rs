...
use crate::modules::branch::repository::branch_repository_seaorm::BranchRepositorySeaorm;
use crate::modules::branch::request::branch_request::*;
use crate::modules::branch::response::branch_response::*;

pub struct BranchServiceSeaorm {
    repo: BranchRepositorySeaorm,
}

impl BranchServiceSeaorm {
    pub fn new(db: &DatabaseConnection) -> Self {
        Self {
            repo: BranchRepositorySeaorm::new(db),
        }
    }
