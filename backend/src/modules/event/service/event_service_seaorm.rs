...
use crate::modules::event::repository::event_repository_seaorm::EventRepositorySeaorm;

pub struct EventServiceSeaorm<'a> {
    repo: EventRepositorySeaorm<'a>,
}

impl<'a> EventServiceSeaorm<'a> {
    pub fn new(db: &'a DatabaseConnection) -> Self {
        Self { repo: EventRepositorySeaorm::new(db) }
    }
