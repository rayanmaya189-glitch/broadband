...
use crate::modules::payment::domain::entities::{payment_link, gateway_config};
...
impl<'a> PaymentRepository<'a> {
    ...
    pub async fn find_link_by_link_id(&self, link_id: &str) -> Result<Option<payment_link::Model>, AppError> {
    ...
    pub async fn find_links_by_invoice(&self, invoice_id: i64) -> Result<Vec<payment_link::Model>, AppError> {
        Ok(payment_link::Entity::find()
    ...
    pub async fn find_links_by_customer(&self, customer_id: i64) -> Result<Vec<payment_link::Model>, AppError> {
        Ok(payment_link::Entity::find()
    ...
    pub async fn find_gateway_config(&self, gateway_id: &str) -> Result<Option<gateway_config::Model>, AppError> {
