...
use crate::modules::audit::service::audit_service_seaorm::AuditServiceSeaorm;

pub async fn search_history(
    State(state): State<SharedState>,
) -> Result<Json<serde_json::Value>, AppError> {
    let svc = AuditServiceSeaorm::new(&state.db_seaorm);
    let repo = crate::modules::audit::repository::entity_history_repository_seaorm::EntityHistoryRepositorySeaorm::new(&state.db_seaorm);
