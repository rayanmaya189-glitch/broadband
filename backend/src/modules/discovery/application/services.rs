...
impl DiscoveryService {
    ...
    ) -> Result<Vec<crate::modules::discovery::domain::entities::discovery_scan::Model>, AppError>
    {
    ...
    pub async fn list_results(
        db: &DatabaseConnection,
    ) -> Result<Vec<crate::modules::discovery::domain::entities::discovery_result::Model>, AppError>
    {
