...
use crate::modules::subscription::repository::subscription_repository_seaorm::SubscriptionRepositorySeaorm;
use crate::modules::subscription::request::subscription_request::*;
use crate::modules::subscription::response::subscription_response::*;

pub struct SubscriptionServiceSeaorm {
    repo: SubscriptionRepositorySeaorm,
}

impl SubscriptionServiceSeaorm {
    pub fn new(db: &DatabaseConnection) -> Self {
        Self {
            repo: SubscriptionRepositorySeaorm::new(db),
        }
    }
