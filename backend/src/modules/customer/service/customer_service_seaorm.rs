...
use crate::modules::customer::repository::customer_repository_seaorm::CustomerRepositorySeaorm;
use crate::modules::customer::request::customer_request::*;
use crate::modules::customer::response::customer_response::*;

pub struct CustomerServiceSeaorm {
    repo: CustomerRepositorySeaorm,
}

impl CustomerServiceSeaorm {
    pub fn new(db: &DatabaseConnection) -> Self {
        Self { repo: CustomerRepositorySeaorm::new(db) }
    }
